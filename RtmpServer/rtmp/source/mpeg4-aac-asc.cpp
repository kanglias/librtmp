...
*/
static uint64_t mpeg4_bits_copy(struct mpeg4_bits_t* dst, struct mpeg4_bits_t* src, int n)
{
	uint64_t v;
...
static uint8_t mpeg4_aac_get_audio_object_type(struct mpeg4_bits_t* bits)
{
...
static uint8_t mpeg4_aac_get_sampling_frequency(struct mpeg4_bits_t* bits)
{
